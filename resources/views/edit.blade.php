...
<div class="container" style="padding: 50px;">
    ...
    <div>
        ...
        @endif
        <form method="post" action="{{route('save-edit-recipe', ['id' => $recipe->id])}}" enctype="multipart/form-data">
            {{ csrf_field() }}
            ...
            <div class="form-group">
                ...
                <script type='text/javascript'>
                    jQuery(document).ready(function(){
                        jQuery("#number_servings option:contains(" + '@php echo $recipe->number_servings @endphp' + ")").attr('selected', 'selected');

                    });
                </script>
                <select name="number_servings"  class="form-control" id="number_servings">
            ...
            <div class="form-group">
                ...
                <input type="text" name="time" class="form-control" value="{{ $recipe->time }}" >
            </div>
            <div class="form-group">
                <label>Уровень сложности</label>
                <script type='text/javascript'>
                    jQuery(document).ready(function(){
                        jQuery("#difficulty_servings option:contains(" + '@php echo $recipe->difficulty @endphp' + ")").attr('selected', 'selected');
            ...
            <div class="form-group">
                ...
                <div style="background-size: cover; width: 300px; height: 200px; background-image:url({{ asset('img/recipes/'. $recipe->prev_img) }})"></div>
                <input type="file" name="prev_img">
            </div>
            <div class="form-group">
                <label>Полное изображение</label>
                <div style="background-size: cover; width: 300px; height: 200px; background-image:url({{ asset('img/recipes/'. $recipe->full_img) }})"></div>
